# Here we will create new prediction function which will return values for prediction
# So first we will import all the libraries
import pandas as pd
from joblib import load
# load all the models and scaler objects
...
# Create function for normalised risk score
...
# Create df which will take values from input_dict
# For that create function for preprocessing input

def preprocess_input(input_dict):
    # Define expected columns for data frame. all columns should be as per X.Test columns
    expected_columns= [
    ...
    # Now manually assign values for each categorical column
